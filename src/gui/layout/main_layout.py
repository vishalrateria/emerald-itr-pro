...
class MainLayoutMixin:
    def setup_layout(self):
        ...
        self.client_master = ClientMaster(
            self, self.handle_client_switch, self.handle_save_and_switch
        )
        self.init_frames()
    ...
    def _setup_main_content(self):
        ...
        self.sidebar = ctk.CTkFrame(
            self.main_container, fg_color=Theme.BG_RECESSED, corner_radius=0
        )
        ...
        ctk.CTkLabel(
            ...
            anchor="w",
            justify="left",
        ).pack(fill="x", padx=SPACING_MD, pady=(SPACING_LG, SPACING_XS))
        self.steps = [
            ...
            {"id": "income_hp", "title": "House Property", "frames": ["hp"]},
            {
                ...
                "frames": ["business_financials", "44ad", "44ada", "44ae", "tb", "bs"],
            },
            {
                "id": "income_cg",
                "title": "Capital Gains",
                "frames": ["stcg", "ltcg", "vda"],
            },
        ...
        self.steps_container = ctk.CTkScrollableFrame(
            ...
            corner_radius=0,
            scrollbar_button_color=Theme.BG_RECESSED,
        )
        ...
        footer_btn_container.pack(
            fill="x", padx=FOOTER_PADDING_X, pady=FOOTER_PADDING_Y
        )
