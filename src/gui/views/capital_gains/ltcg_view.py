from src.config import MAX_ENTRIES_CG
...
class LTCGSchedule:
    ...
    def create_frame(parent, fv, sl, validation_refs=None):
        ...
        def ltcg_row_gen(i):
            return [
                {
                    "textvariable": fv[f"ltcg112a_{i}_isin"],
                    "key": f"ltcg112a_{i}_isin",
                    "font": Theme.DATA,
                    **Theme.get_entry_style(),
                    "weight": 1,
                },
                {
                    "textvariable": fv[f"ltcg112a_{i}_name"],
                    "key": f"ltcg112a_{i}_name",
                    "font": Theme.BODY,
                    **Theme.get_entry_style(),
                    "weight": 2,
                },
                {
                    "textvariable": fv[f"ltcg112a_{i}_sale"],
                    "key": f"ltcg112a_{i}_sale",
                    "font": Theme.DATA,
                    "justify": "right",
                    **Theme.get_entry_style(),
                    "weight": 1,
                ...
                {
                    "textvariable": fv[f"ltcg112a_{i}_cost"],
                    "key": f"ltcg112a_{i}_cost",
                    "font": Theme.DATA,
                    "justify": "right",
                    **Theme.get_entry_style(),
                    "weight": 1,
                ...
                {
                    "textvariable": fv[f"ltcg112a_{i}_fmv"],
                    "key": f"ltcg112a_{i}_fmv",
                    "font": Theme.DATA,
                    "justify": "right",
                    **Theme.get_entry_style(),
                    "weight": 1,
                ...
                {
                    "textvariable": fv[f"ltcg112a_{i}_gain"],
                    "font": Theme.DATA,
                    "justify": "right",
                    "state": "readonly",
        ...
        card_spacer(bb_card)
        field_row(
            bb_card, "Date of Acquisition (DD-MM-YYYY)", fv.get("buyback_acq_date")
        )
        ...
        field_row(
            other_112_card,
            "LTCG on Land / Buildings / Unlisted Shares ₹",
            fv["ltcg_112_input"],
        )
        field_row(
            other_112_card, "Exemption u/s 54 / 54F / 54EC ₹", fv["ltcg_112_exemption"]
        )
        ...
        field_row(
            relief_card, "Date of Acquisition (DD-MM-YYYY)", fv["ltcg_prop_acq_date"]
        )
        field_row(relief_card, "Indexation Cost (if any) ₹", fv["ltcg_prop_index_cost"])
        field_row(
            relief_card,
            "Recommended Relief Amount ₹",
            fv["ltcg_prop_relief_amt"],
            state="readonly",
        )
        ...
        q_card = make_card(
            f, "QUARTERLY BREAKUP OF CAPITAL GAINS (FOR 234C RELAXATION)"
        )
        info_banner(
            f,
